            ...
            if($email_valid!='' && $phone_valid!=''){
                ...
                elseif($auth_phone_count> 0 && $customer_phone_count >0 )
                {
                   // Session::flash('error', 'Phone number Already Exists'); 
                    ...
                    $CustomerDetails->country_id = $request->country_id;
                    $CustomerDetails->state_id = $request->state_id ;
                    $CustomerDetails->city_id = $request->city_id ;
                    $CustomerDetails->address_one = $request->address_one;
                    $CustomerDetails->address_two = $request->address_two;
                    $CustomerDetails->zipcode = $request->pincode ; 
