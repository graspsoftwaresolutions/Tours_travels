                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                             <a href="http://demo.graspsoftwaresolutions.com/tours/login" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Login</a>
                        </td>
                      </tr>
                    </table>
                  </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr> 
            <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">{{ $website_dat->company_address_one ? $website_dat->company_address_one : '' }} , {{ $website_dat->company_address_two ? $website_dat->company_address_two : '' }}</p>
              <p style="margin: 0;">{{ $website_dat->company_email ? $website_dat->company_email : '' }}, {{ $website_dat->company_phone ? $website_dat->company_phone : '' }}</p>
			  <p style="margin: 0;">{{ $website_dat->company_website ? $website_dat->company_website : '' }}</p>
            </td>
