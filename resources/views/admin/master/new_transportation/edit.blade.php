...
<section class="content-wrapper">
   ...
   <div class="container-fluid">
      ...
      @php $row = $data['edit_view'][0];  @endphp
      <div class="page-content clearfix">
         <!-- <div class="col-sm-10 col-sm-offset-1"> -->
         @include('includes.messages')
         <form id="TransportationformValidate" autocomplete='off' action="{{route('update_transportation')}}" class="wrapper-boxed paper p30 mt30" method="post" data-toggle="validator">
            @csrf 
            ...
            <div class="row">
               ...
               <div class="col-sm-6">
                  <div class="form-group">
                     <div>				
                        <input class="with-gap" name="type" type="radio"  checked="checked" id="pack" value="Pack" @isset($row)
                                {{ $row->type=='Pack' ? 'checked' : '' }}
                                @endisset >
                        <label for="pack" class="inline">Pack</label>	    
                        <input class="with-gap" name="type" type="radio" id="Unpack" value="Unpack" @isset($row)
                                {{ $row->type=='Unpack' ? 'checked' : '' }}
                                @endisset >
            ...
            <div class="row packdetails">
               <div class="col-sm-6">
                   <div class="input-field label-float">
						<input placeholder="Pack Name" value="{{$row->pack_name ? $row->pack_name : '' }}" class="clearable" id="pack_name" name="pack_name" autofocus type="text">
               ...
               <div class="col-sm-6">
                  <div class="input-field label-float">
						<input placeholder="Pack Amount" value="{{$row->transport_pack_amount ? $row->transport_pack_amount : '' }}"  class="clearable" id="transport_pack_amount" name="transport_pack_amount" autofocus type="text">
            ...
            <div class="row unpackdetails">
               <div class="col-sm-6">
                   <div class="input-field label-float">
						<input placeholder="Amount Per Km" class="clearable" value="{{$row->unpack_amount_per_km ? $row->unpack_amount_per_km : '' }}" id="unpack_amount_per_km" name="unpack_amount_per_km" autofocus type="text">
               ...
               <div class="col-sm-6">
                  <div class="input-field label-float">
						<input placeholder="Amount Per Hour" class="clearable" value="{{$row->unpack_amount_per_hr ? $row->unpack_amount_per_hr : '' }}" id="unpack_amount_per_hr" name="unpack_amount_per_hr" autofocus type="text">
