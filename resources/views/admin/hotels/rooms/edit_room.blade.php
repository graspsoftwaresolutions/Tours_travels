   ...
   <div class="container-fluid">
      ...
      <div class="page-content">
         ...
         <div class="paper toolbar-parent mt10">
            <form id="wizard1"  class="paper formValidate" method="post" action="{{ route('edit.hotelrooms') }}" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="row">
                        ...
                        <div id="hotel_image_{{ $image->id }}" class="col-xs-12 col-sm-2 mt20">
                            <img class="responsive-img z-depth-1" data-action="zoom" src="{{ asset('storage/app/hotels/room/'.$image->image_name) }}" style="width:190px;height: 130px;" alt="">
