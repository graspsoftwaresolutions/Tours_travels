                            ...
                            <tbody>
                               ...
                               @php //$hotel_name = CommonHelper::getHotelnames($values->hotel_id); dd($hotel_name); @endphp
                                    <tr>
                                        ...
                                        <td>@php
                                            $encid = Crypt::encrypt($values->hotelroomid);
                                         if($values->roomstatus==1)
                                                        echo "Active";
                                                else
                                                 echo "Inactive";
                                              @endphp</td> 
                                        <td> <a   href='{{ route("hotel_room_edit",$encid) }}' class="btn btn-sm blue waves-effect waves-circle waves-light"><i class="mdi mdi-lead-pencil"></i></a>
                                        &nbsp;</td>
                                    </tr>
                               @endforeach           
