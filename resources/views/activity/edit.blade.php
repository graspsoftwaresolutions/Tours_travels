                    ...
                    <div class="row">
                        ...
                        <div class="divider theme ml14 mr14"></div>
                            ...
                            <div id="activity_image_{{ $image->id }}" class="col-xs-12 col-sm-2 mt20">
                                <img class="responsive-img z-depth-1" data-action="zoom" src="{{ asset('storage/app/activity/'.$image->image_name) }}" style="width:190px;height: 130px;" alt="">
...
$('.deleteoptn').click(function()
{
  ...
  if (confirm("{{ __('Are you sure you want to delete?') }}")) {
   ...
   $('.delete_exclusion').click(function()
   {
   var id = $(this).attr('id');
   var strsp = id.split("|");
   var actid = strsp[1]; //17
  ...
  function DeleteInclusion(inclusionid)
  {
   if (confirm("{{ __('Are you sure you want to delete?') }}")) {
      ...
      console.log(value);
      alert(value);
      //   var url = "{{ url('/delete_inclusion') }}" + '?id=' + inclusionid + '&inclusionname=' + value ;
