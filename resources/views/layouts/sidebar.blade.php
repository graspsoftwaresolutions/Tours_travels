                    ...
                    <ul class="nav navbar-nav navbar-right navbar-search-link">
                        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Home<span><i class="fa fa-angle-down"></i></span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="landing-page.html">Landing Page</a></li> <li><a href="travel-agency-homepage.html">Travel Agency Page</a></li>
                                <li><a href="tour-booking.html">Booking Page</a></li>
                                 <li><a href="travel-agency-homepage.html">Travel Agency Page</a></li>
 <li><a href="admin-demo/index.html">Admin Dashboard</a></li></ul>			
                        </li>
