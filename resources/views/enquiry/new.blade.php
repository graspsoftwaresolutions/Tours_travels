	...
	<!-- =========================================================== -->
		...
		<div class="container-fluid">			
            ...
            @include('includes.messages')
					<form id="formValidate" class="wrapper-boxed paper p30 mt30" data-toggle="validator">
                   ...
                   <div class="row">
                     ...
                     <div class="select-row form-group">
                           ...
                           <div class="input-highlight"></div>
							...
							<div class="col-sm-6">
								<div class="form-group input-field label-float">   
                              <input placeholder="Address" class="clearable" id="address" name="address_one" type="text">
				...
				$.ajax({
					...
					success: function(response){
						...
						{ 
							...
							if(response.userid)
							{
								window.location = '{{URL::to('withdrawl_profile')}}/'+id;
							}
