                    ...
                    <td align="center" bgcolor="#f6f6f6">
                        <table style="margin:0 10px" border="0" cellpadding="0" cellspacing="0" width="640">
                            <tbody><tr><td height="20" width="640"></td></tr>
                                ...
                                <tr>
                                    <td width="640" style="background-color:#faa61a;padding:20px 30px">
                                        <table border="0" cellpadding="0" cellspacing="0" width="640">
                                            <tbody>
                                                <tr>
                                                    <td align="left" valign="middle" width="350">
                                                        Reference Id : {{ $package_data->reference_number }} <br>
                                                        Package Name : {{ $package_data->package_name }} <br>
                                                    ...
                                                    <td width="580">
                                                        <table border="0" cellpadding="0" cellspacing="0" width="580">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td width="580">
                                                                        <p style="font-size:16px;line-height:20px;color:#faa61a;font-weight:bold;margin-top:0px;margin-bottom:0px;font-family:Arial,Helvetica,Geneva,sans-serif;text-transform:capitalize" align="left">Dear Admin,</p>
                                                                        <div style="font-size:13px;line-height:18px;color:#444444;margin-top:0px;font-family:Arial,Helvetica,Geneva,sans-serif" align="left">
                                                                            <p style="text-align:justify;margin-top:8px;margin-bottom:0px">The customer has been customized the new itineray details.Kindly check!!
                                                                            </p>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                    ...
                                                                    <td width="580">
                                                                        <div style="font-size:13px;color:rgb(68,68,68);margin-top:0px;margin-bottom:8px;font-family:Arial,Helvetica,Geneva,sans-serif" align="left">
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    <td>Total Amount</td>
                                                                                    <td>: {{ $package_data->total_amount ? $package_data->total_amount : '' }}</td>
                                                                                </tr>
                                                                                </tr>
                                                                            </tbody></table>
