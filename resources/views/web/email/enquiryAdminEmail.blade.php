                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                       ...
                       <p style='margin-left:10px'> Phone :  {{ $details['phone'] ? $details['phone'] : '' }}</p>
                       <p style='margin-left:10px'> Address :  {{ $details['address'] ? $details['address'] : '' }} </p>    
                       <p style='margin-left:10px'>Message :  {{ $details['message'] ? $details['message'] : '' }}</p>
