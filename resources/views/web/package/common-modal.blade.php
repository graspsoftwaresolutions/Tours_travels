                              ...
                              <div class="row"> 
                                ...
                                <div class="col-md-8">
                                  <div class="rating" style="color: #faa61a;">
                                    <span><i id="viewrating-1" class="viewrating fa fa-star"></i></span>
                                    <span><i id="viewrating-2" class="viewrating fa fa-star"></i></span>
                                    <span><i id="viewrating-3" class="viewrating fa fa-star"></i></span>
                                    <span><i id="viewrating-4" class="viewrating fa fa-star"></i></span>
                                    <span><i id="viewrating-5" class="viewrating fa fa-star-0"></i></span>
                                  </div>
                                </div>
                              </div>
                              <br>
