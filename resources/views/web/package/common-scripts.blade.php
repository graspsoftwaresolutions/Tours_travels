               ...
               $.each(resultdata, function(key, value) {
                  ...
                  if(rating_no!=null){
                    for (r = 1; r <= rating_no; r++) {
                      rating_string += '<span><i id="listviewrating-'+r+'" class="listviewrating fa fa-star"></i></span>';
                    }
                  ...
                  for (e = 1; e <= empty_rating; e++) {
                    rating_string += '<span><i id="listviewrating-'+parseInt(e)+parseInt(rating_no)+'" class="listviewrating fa fa-star-o"></i></span>';
                  }
    ...
    //   }
      ...
      $.ajax({
          ...
          success: function(resultdata) {
            ...
            $(".viewrating").removeClass('fa-star');
            $(".viewrating").addClass('fa-star-o');
            if(rating_no!=null){
              for (r = 1; r <= rating_no; r++) {
                $("#viewrating-"+r).removeClass('fa-star-o');
                $("#viewrating-"+r).addClass('fa-star');
              }
            }
